...
var dao = require('zeus-templates/data/dao/Build/ConfigMaps');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('ConfigMaps not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/zeus-templates/api/ConfigMaps.js/' + entity.Id);
