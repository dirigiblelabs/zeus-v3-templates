...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'zeus.Build.ConfigMaps.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('zeus.Build.ConfigMaps.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v3/js/zeus-templates/api/Build/ConfigMaps.js';
